...
import imghero from "../../Images/blog_1.jpg"
const Main = () => {
  return (
        <>
  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 className="w-96 title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900  ">Knausgaard typewriter readymade marfa</h1>
    ...
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <img className="object-cover shadow-lg  object-center rounded" alt="hero" src={imghero}/>
    </div>
  </div>
</section>
